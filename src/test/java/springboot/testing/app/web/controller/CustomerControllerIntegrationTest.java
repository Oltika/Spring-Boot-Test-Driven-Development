...
public class CustomerControllerIntegrationTest {
  ...
  void addCustomer() throws Exception {
    Customer customer = new Customer("", "John", "Doe", "jdoe@test.com",
            "555-515-1234", "1234 Main St, Smallville KS 66083");
  ...
  void addCustomer_exists() throws Exception {
    Customer customer = new Customer("","Cally","Reynolds",
            "penatibus.et@lectusa.com","(901) 166-8355","556 Lakewood Park, Bismarck, ND 58505");
    ObjectMapper mapper = new ObjectMapper();
    String jsonString = mapper.writeValueAsString(customer);
    this.mockMvc.perform(post("/customers").content(jsonString).contentType("application/json"))
  ...
  void updateCustomer_badRequest() throws Exception {
    ...
    this.mockMvc.perform(put("/customers/2b31469c-da3d-469f-9900-d00b5e4e352f")
      .content(jsonString).contentType("application/json")).andExpect(status().isBadRequest());
  }
